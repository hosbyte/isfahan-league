...
// ? database conection
$query = ("SELECT * FROM `daste1z14` ORDER BY point DESC , gd DESC, name ASC");
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-10 col-xl-8">
                        <div class="table-responsive rounded-3 shadow-sm" style="margin-bottom: 80px;">
                            <table class="gradient-table-wrapper gradient-table table-size" style="color : black; font-size: 30px; font-weight: bold;">
                                <thead style="text-align: center;">
                                    <tr>
                                        <th scope="col" style="font-size: 24px;">رتبه</th>
                                        <th scope="col" style="font-size: 24px;" class="width">نام تیم</th>
                                        ...
                                        <?php
                                            ...
                                            while ($show = mysqli_fetch_assoc($sql))
                                            {
                                                ...
                                                echo "
                                                    <tr>
                                                        <th scope=\"row\">$num</th>
                                                        <td style=\"font-size: 17px;\" class=\"width\">$name</td>
                                                        <td>$point</td>
                                                        <td>$mp</td>
                                                        <td>$win</td>
                                                        <td>$drow</td>
