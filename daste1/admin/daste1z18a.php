...
// ? database conection
$query = ("SELECT * FROM `daste1z18` ORDER BY point DESC , gd DESC, name ASC");
...
<html lang="fa" dir="rtl">
    ...
    <body class="body">
        ...
        <button id="downloadTable" class="btn btn-success" 
            ...
            background: linear-gradient(to right, rgba(0, 0, 0, 1), rgba(0, 255, 0, 0.7)); color: white;">
        ...
        <style>
            ...
            .box-name {
                ...
                max-width: 600px;
                width: 90%;
                background: linear-gradient(to right, rgba(0, 0, 0, 1), rgba(0, 255, 0, 0.7));
                color: white;
                text-align: center;
                border-radius: 12px;
