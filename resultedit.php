...
if(isset($_POST['table']) && !empty($_POST['table']))
{
  ...
  // اعتبارسنجی 
  $allowed_tables = ['bartar13', 'bartar14', 'bartar15', 'bartar17', 'bartar18', 'bartar19', 'bartar21', 'daste1b','daste1z19' ,'daste1z18', 'daste1z17', 'daste1z15', 'daste1z14', 'daste1z13' ,'osve'];
